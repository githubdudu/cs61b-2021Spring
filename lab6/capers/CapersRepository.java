...
public class CapersRepository {
    ...
    public static void writeStory(String text) {
        ...
        String newLine = "\n";
        String prev = "";
        String storyFileName = "story.txt";

        File story = new File(CAPERS_FOLDER, storyFileName);
        if (story.exists()) {
            prev = readContentsAsString((story));
        }
        writeContents(story, prev, text, newLine);
